...
GENERATIVE_ENCODER_PATH="data/models/vjepa2-vitg-fpc64-384-ssv2"
VJEPA_MODEL_NAME="vit_giant_384"
OUTPUT_DIR="ckpt/gen-vjepa-7b-spatial-reasoning-s1"
CACHE_DIR="./cache"
mkdir -p $OUTPUT_DIR
...
torchrun --nproc_per_node=$NPROC_PER_NODE \
            ...
            --generative_encoder_tower_type "vjepa_online" \
            --generative_encoder_path $GENERATIVE_ENCODER_PATH \
            --generative_vision_tower_model_name $VJEPA_MODEL_NAME \
