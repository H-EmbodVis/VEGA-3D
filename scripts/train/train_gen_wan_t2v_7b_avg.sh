#!/bin/bash
# Training script: Qwen2.5-VL + Wan2.1-T2V-1.3B generative encoder (spatial reasoning)
...
OUTPUT_DIR="ckpt/gen-wan_t2v-7b-spatial-reasoning-s1-avg-bs128"
CACHE_DIR="./cache"
mkdir -p $OUTPUT_DIR
