...
# Path Configuration
# ======================
MODEL_PATH="data/models/Qwen2.5-VL-3B-Instruct/"  # [ModelArguments] Pretrained model path
GEOMETRY_ENCODER_TYPE="vggt"
GEOMETRY_ENCODER_PATH="data/models/VGGT-1B"
OUTPUT_DIR="ckpt/baseline-vgllm-4B-spatial-reasoning-s1"                   # Directory for saving checkpoints
