...
GENERATIVE_ENCODER_PATH="data/models/stable-video-diffusion-img2vid"
OUTPUT_DIR="ckpt/gen-svd-7b-spatial-reasoning-s1"
CACHE_DIR="./cache"
mkdir -p $OUTPUT_DIR
...
torchrun --nproc_per_node=$NPROC_PER_NODE \
            ...
            --generative_encoder_tower_type "svd_online" \
