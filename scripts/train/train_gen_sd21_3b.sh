...
GENERATIVE_ENCODER_PATH="data/models/stable-diffusion-2-1-base"
OUTPUT_DIR="ckpt/gen-sd21-3b-spatial-reasoning-s1"
CACHE_DIR="./cache"
mkdir -p $OUTPUT_DIR
...
torchrun --nproc_per_node=$NPROC_PER_NODE \
            ...
            --generative_encoder_tower_type "sd21_online" \
