#!/bin/bash
# Recommended open-source release config: Qwen2.5-VL + Wan2.1-T2V-1.3B with token_gated_residual fusion.
...
OUTPUT_DIR="ckpt/gen-wan_t2v-7b-token-gated-residual-s1"
CACHE_DIR="./cache"
mkdir -p $OUTPUT_DIR
