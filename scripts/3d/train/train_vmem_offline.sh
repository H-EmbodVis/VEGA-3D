...
GENERATIVE_MODEL_ID="vmem_onestep_t250_input16"
...
RUN_NAME="${RUN_NAME:-llavanext-qwen-video3dllm-uniform-vmem-offline}"
...
echo "Extracting VMEM offline features for ${GENERATIVE_MODEL_ID} ..."
...
torchrun --nnodes=1 --nproc_per_node="${NUM_GPUS}" --master_port 43002 \
