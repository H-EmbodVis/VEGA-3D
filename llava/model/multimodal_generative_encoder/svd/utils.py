...
class customunet(UNetSpatioTemporalConditionModel):
    def forward(
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            # Diffusers API differs by version: some up blocks do not accept `upsample_size`.
            if upsample_size is not None and "upsample_size" in inspect.signature(upsample_block.forward).parameters:
