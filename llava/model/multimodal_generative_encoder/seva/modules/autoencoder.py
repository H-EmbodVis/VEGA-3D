...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, chunk_size: int | None = None, sd_model_path: str | None = None):
        super().__init__()
        sd_model_path = sd_model_path or os.getenv("SEVA_SD21_BASE_CKPT_DIR", "ckpts/stable-diffusion-2-1-base")
