...
class ModelArguments:
    ...
    use_generative_feature: Optional[bool] = field(default=False)
    generative_feat_dim: Optional[int] = field(default=1280)
    generative_projector_type: Optional[str] = field(default="mlp2x_gelu")
    generative_feature_source: Optional[str] = field(default="offline")
    generative_vision_tower_type: Optional[str] = field(default="wan_vace_online")
    generative_vision_tower_checkpoint: Optional[str] = field(default=None)
    generative_vision_tower_task: Optional[str] = field(default="vace-1.3B")
    generative_vision_tower_size: Optional[str] = field(default="832*480")
    generative_vision_tower_timestep: Optional[int] = field(default=300)
    generative_vision_tower_shift: Optional[float] = field(default=5.0)
    generative_vision_tower_context_scale: Optional[float] = field(default=1.0)
    generative_vision_tower_feat_block_idx: Optional[int] = field(default=-1)
    generative_vision_tower_condition_on_first_frame: Optional[bool] = field(default=True)
    generative_vision_tower_weight_name: Optional[str] = field(default=None)
    generative_vision_tower_model_version: Optional[float] = field(default=None)
    generative_vision_tower_input_size: Optional[int] = field(default=None)
    generative_vision_tower_output_spatial: Optional[int] = field(default=14)
    generative_vision_tower_height: Optional[int] = field(default=None)
    generative_vision_tower_width: Optional[int] = field(default=None)
    generative_vision_tower_num_frames: Optional[int] = field(default=None)
    generative_vision_tower_num_inference_steps: Optional[int] = field(default=1)
    generative_vision_tower_pool_kernel: Optional[int] = field(default=2)
    generative_vision_tower_model_name: Optional[str] = field(default=None)
    generative_vision_tower_img_size: Optional[int] = field(default=None)
    generative_vision_tower_tubelet_size: Optional[int] = field(default=2)
    generative_vision_tower_pretrained: Optional[bool] = field(default=False)
    generative_vision_tower_clip_checkpoint: Optional[str] = field(default=None)
    generative_vision_tower_sd21_checkpoint: Optional[str] = field(default=None)
    generative_vision_tower_empty_prompt_path: Optional[str] = field(default=None)
    generative_vision_tower_prompt_emb_path: Optional[str] = field(default=None)
    generative_vision_tower_dtype: Optional[str] = field(default="bf16")
    generative_vision_tower_chunk_size: Optional[int] = field(default=32)
    generative_vision_tower_cfg_min: Optional[float] = field(default=1.2)
    generative_vision_tower_camera_scale: Optional[float] = field(default=2.0)
    # <=0 means unlimited (cache all scenes seen in training).
    generative_cache_max_items: Optional[int] = field(default=-1)
    generative_profile: Optional[bool] = field(default=False)
    use_feat_fusion: Optional[bool] = field(default=False)
    feature_fusion_method: Optional[str] = field(default="add")
    ...
    instruction_tail_keep_tokens: Optional[int] = field(default=96, metadata={"help": "Keep last K human instruction tokens after template filtering."})
    instruction_relation_boost: Optional[float] = field(default=2.0, metadata={"help": "Boost weight for relation-direction tokens in instruction summary."})
...
class DataArguments:
    ...
    generative_model_id: Optional[str] = field(default=None)
        ...
        if "image" in sources[0]:
            ...
            try:
                video_dict = self.video_processor.process_3d_video(
                    ...
                    generative_model_id=self.data_args.generative_model_id,
                    generative_feature_source=getattr(self.data_args, "generative_feature_source", "offline"),
                )
...
def get_model(model_args, training_args, bnb_model_from_pretrained_args):
    ...
    if any(
        [
            model_args.use_generative_feature is not None,
    ...
    if model_args.use_generative_feature is not None:
        overwrite_config["use_generative_feature"] = model_args.use_generative_feature
        overwrite_config["generative_feat_dim"] = model_args.generative_feat_dim
        overwrite_config["generative_projector_type"] = model_args.generative_projector_type
        overwrite_config["generative_feature_source"] = model_args.generative_feature_source
        overwrite_config["generative_vision_tower_type"] = model_args.generative_vision_tower_type
        overwrite_config["generative_vision_tower_checkpoint"] = model_args.generative_vision_tower_checkpoint
        overwrite_config["generative_vision_tower_task"] = model_args.generative_vision_tower_task
        overwrite_config["generative_vision_tower_size"] = model_args.generative_vision_tower_size
        overwrite_config["generative_vision_tower_timestep"] = model_args.generative_vision_tower_timestep
        overwrite_config["generative_vision_tower_shift"] = model_args.generative_vision_tower_shift
        overwrite_config["generative_vision_tower_context_scale"] = model_args.generative_vision_tower_context_scale
        overwrite_config["generative_vision_tower_feat_block_idx"] = model_args.generative_vision_tower_feat_block_idx
        overwrite_config["generative_vision_tower_condition_on_first_frame"] = model_args.generative_vision_tower_condition_on_first_frame
        overwrite_config["generative_vision_tower_weight_name"] = model_args.generative_vision_tower_weight_name
        overwrite_config["generative_vision_tower_model_version"] = model_args.generative_vision_tower_model_version
        overwrite_config["generative_vision_tower_input_size"] = model_args.generative_vision_tower_input_size
        overwrite_config["generative_vision_tower_output_spatial"] = model_args.generative_vision_tower_output_spatial
        overwrite_config["generative_vision_tower_height"] = model_args.generative_vision_tower_height
        overwrite_config["generative_vision_tower_width"] = model_args.generative_vision_tower_width
        overwrite_config["generative_vision_tower_num_frames"] = model_args.generative_vision_tower_num_frames
        overwrite_config["generative_vision_tower_num_inference_steps"] = model_args.generative_vision_tower_num_inference_steps
        overwrite_config["generative_vision_tower_pool_kernel"] = model_args.generative_vision_tower_pool_kernel
        overwrite_config["generative_vision_tower_model_name"] = model_args.generative_vision_tower_model_name
        overwrite_config["generative_vision_tower_img_size"] = model_args.generative_vision_tower_img_size
        overwrite_config["generative_vision_tower_tubelet_size"] = model_args.generative_vision_tower_tubelet_size
        overwrite_config["generative_vision_tower_pretrained"] = model_args.generative_vision_tower_pretrained
        overwrite_config["generative_vision_tower_clip_checkpoint"] = model_args.generative_vision_tower_clip_checkpoint
        overwrite_config["generative_vision_tower_sd21_checkpoint"] = model_args.generative_vision_tower_sd21_checkpoint
        overwrite_config["generative_vision_tower_empty_prompt_path"] = model_args.generative_vision_tower_empty_prompt_path
        overwrite_config["generative_vision_tower_prompt_emb_path"] = model_args.generative_vision_tower_prompt_emb_path
        overwrite_config["generative_vision_tower_dtype"] = model_args.generative_vision_tower_dtype
        overwrite_config["generative_vision_tower_chunk_size"] = model_args.generative_vision_tower_chunk_size
        overwrite_config["generative_vision_tower_cfg_min"] = model_args.generative_vision_tower_cfg_min
        overwrite_config["generative_vision_tower_camera_scale"] = model_args.generative_vision_tower_camera_scale
        overwrite_config["generative_cache_max_items"] = model_args.generative_cache_max_items
        overwrite_config["generative_profile"] = model_args.generative_profile
        overwrite_config["use_feat_fusion"] = model_args.use_feat_fusion
        overwrite_config["feature_fusion_method"] = model_args.feature_fusion_method
        overwrite_config["fusion_attention_heads"] = model_args.fusion_attention_heads
        overwrite_config["fusion_dropout"] = model_args.fusion_dropout
        overwrite_config["fusion_num_layers"] = model_args.fusion_num_layers
        overwrite_config["instruction_tail_keep_tokens"] = model_args.instruction_tail_keep_tokens
        overwrite_config["instruction_relation_boost"] = model_args.instruction_relation_boost
...
def train(attn_implementation=None):
    ...
    data_args.use_generative_feature = bool(model_args.use_generative_feature)
    if data_args.use_generative_feature:
        data_args.generative_feature_source = model_args.generative_feature_source
    else:
        # Hard-disable both offline load and online encoding in dataset preprocessing.
        data_args.generative_feature_source = "none"
    ...
    setattr(model.config, "instruction_tail_keep_tokens", int(model_args.instruction_tail_keep_tokens))
    setattr(model.config, "instruction_relation_boost", float(model_args.instruction_relation_boost))

    # Token-level lexical priors for instruction-aware gating:
    # - relation tokens are preserved and upweighted.
    # - template tokens are downweighted/filtered in llava_arch context extractor.
    relation_phrases = [
        "left",
        "right",
        "front",
    ...
    relation_token_ids = set()
    for phrase in relation_phrases:
        relation_token_ids.update(int(x) for x in tokenizer.encode(phrase, add_special_tokens=False) if int(x) >= 0)
    setattr(model.config, "instruction_relation_token_ids", sorted(relation_token_ids))
    ...
    template_token_ids = set()
    for phrase in template_phrases:
        template_token_ids.update(int(x) for x in tokenizer.encode(phrase, add_special_tokens=False) if int(x) >= 0)
    # Do not filter relation tokens even if they appear in template text.
    template_token_ids = template_token_ids - relation_token_ids
    setattr(model.config, "instruction_template_token_ids", sorted(template_token_ids))
